...
export function PageHeader({ title, subtitle, actions }: Props) {
  return (
    <header className="sticky top-0 z-30 flex flex-wrap items-center gap-3 sm:gap-4 border-b border-rule bg-cream/95 backdrop-blur px-4 sm:px-6 lg:px-10 py-4 lg:py-[22px] mb-4 lg:mb-5">
      <MobileMenuButton />
