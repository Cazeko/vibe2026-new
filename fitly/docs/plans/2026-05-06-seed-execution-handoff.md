...
| Phase 4-3a | 2026-05-06 | schema 정리 + drizzle generate | 73557e4 | ✅ schema 5 제거 + drizzle/0000_exotic_boomerang.sql 생성 (12 CREATE/6 FK/12 INDEX) |
| D-S1.5 | 2026-05-06 | 폐기 사용처 코드 정리 | 506c15a | ✅ 18 routes + 5 pages + components 폐기, `npm run build` 통과 (10/10 tests) |
| Phase 4-3b | 2026-05-06 | DB 백업 + DROP 보강 + 적재 | (직접) | ✅ **완료** — 백업 245 rows + DROP 4 보강 + drizzle/0000 직접 실행 + 적재 스크립트. exam_papers 57, exam_items 593, cards 648 (quiz 443 + keyword 205). 24년 × papers, 모든 row 정합 |
